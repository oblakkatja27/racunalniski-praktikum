\begin{frame}{Matrike}
	...
	\href{https://www.overleaf.com/learn/latex/Matrices}{\beamergotobutton{Matrices}} % delalo bi tudi brez \beamergotobutton{button text}
\end{frame}
...
\begin{frame}{Okolje \texttt{cases}}
	...
	\[
	\begin{cases}
		\displaystyle \frac{3x^2y-y^3}{x^2+y^2}; & (x,y) \ne (0,0), \\
		a; & (x,y) = (0,0).
	\end{cases}
	\]
